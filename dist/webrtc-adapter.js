 ...
 */
export function setWebRTCAdapter(adapter) {
 ...
 */
export function getWebRTCAdapter(overrideAdapter) {
    if (overrideAdapter) {
    ...
    throw new Error('WebRTC is not available natively in this environment and "werift" could not be loaded. ' +
